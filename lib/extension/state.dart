...
extension EXT on State {
  ...
  static final List<Widget> _titles = [
    ...
    Text("Live_Tv".tr(), style: titleStyle),
    Text("Movies".tr(), style: titleStyle),
    Text("Series".tr(), style: titleStyle),
    Text("favorites".tr(), style: titleStyle),
  ];
    ...
    return AppBar(
      ...
      actions: [
        ...
        PopupMenuButton(
          elevation: 0,
          color: Colors.white,
          icon: Icon(CupertinoIcons.ellipsis_vertical, color: palette.white),
          onSelected: (value) {
