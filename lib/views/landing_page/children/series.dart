...
import 'package:seizhiptv/views/landing_page/children/series_children/fav_series.dart';
import 'package:seizhiptv/views/landing_page/children/series_children/series_category.dart';
import 'package:seizhiptv/views/landing_page/children/series_children/series_history.dart';
import 'package:seizhiptv/views/landing_page/children/series_children/series_list.dart';
...
class _SeriesPageState extends State<SeriesPage> {
  ...
  initStream() {
    _vm.stream.listen((event) {
      ...
      for (final String label in categoryName!) {
        if (label.contains(
          "ALL (${seriesData == null ? "" : seriesData.length})",
        )) {
          dropdownvalue = label;
        }
      }
  ...
  final GlobalKey<SeriesHistoryPageState> _hisPage =
      GlobalKey<SeriesHistoryPageState>();
