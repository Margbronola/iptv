...
import 'package:seizhiptv/models/movie_details.dart';
import 'package:seizhiptv/views/landing_page/children/details.dart';
...
class _MovieDetailsPageState extends State<MovieDetailsPage> {
  ...
  void initState() {
    ...
    MovieAPI().searchMovie(title: widget.title, year: widget.year).then((
      value,
    ) {
      if (value != null) {
        print("MOVIE DETAILS: $value");
        MovieAPI().movieDetails(value);
      }
    });
    super.initState();
  }
