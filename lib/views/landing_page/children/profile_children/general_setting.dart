...
import 'package:seizhiptv/models/language.dart';
...
class _GeneralSettingPageState extends State<GeneralSettingPage> {
  ...
  List<Language> languageList = [
    Language(langName: 'English', locale: const Locale('en')),
    Language(langName: 'French', locale: const Locale('fr')),
  ];
              ...
              children: [
                ...
                Container(
                  ...
                  child: DropdownButton<Language>(
                    ...
                    dropdownColor: ColorPalette().card,
                    icon: Expanded(
                      child: Container(
