...
class SeriesHistoryPage extends StatefulWidget {
  SeriesHistoryPage({
    super.key,
    required this.data,
  ...
  @override
  State<SeriesHistoryPage> createState() => SeriesHistoryPageState();
}

class SeriesHistoryPageState extends State<SeriesHistoryPage> {
  String searchText = "";
  ...
  Widget build(BuildContext context) {
    if (widget.data.isEmpty) {
      return const Center(child: Text("No Series history"));
    }
