...
import 'package:seizhiptv/extension/classified_data.dart';
...
import 'package:seizhiptv/views/landing_page/children/series_children/episode.dart';
...
class _SeriesDetailsPageState extends State<SeriesDetailsPage>
  ...
  void initState() {
    ...
    TVSeriesAPI().searchTV(title: widget.title, year: widget.year).then((
      ...
      if (value != null) {
        TVSeriesAPI().seriesDetails(value);
      }
    });
    ...
    for (final title in titles) {
      final item = widget.data.data.firstWhere(
